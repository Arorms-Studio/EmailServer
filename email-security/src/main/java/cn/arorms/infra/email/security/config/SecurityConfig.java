package cn.arorms.infra.email.security.config;
...
import cn.arorms.infra.email.security.JwtToAppUserAuthenticationConverter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
                                                   ...
                                                   JwtToAppUserAuthenticationConverter jwtToAppUserAuthConverter) throws Exception {
        http
                ...
                .oauth2ResourceServer(rs -> rs
                        .jwt(jwt -> jwt.jwtAuthenticationConverter(jwtToAppUserAuthConverter))
